...
import olivia.com.jpa.repository.BookCategoryRepository;
...
public class JpaOneToMany implements CommandLineRunner {
	private static final Logger logger = LoggerFactory.getLogger(JpaOneToMany.class);
	
	@Autowired
	private BookCategoryRepository bookCategoryRepository;
	
	public static void main(String[] args) {
		SpringApplication.run(JpaOneToMany.class, args);
	}
